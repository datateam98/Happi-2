...
package happi.quittancement2019_main_0_1;
...
/**
 * Job: Quittancement2019_main Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class Quittancement2019_main implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "Quittancement2019_main";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Quittancement2019_main.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Quittancement2019_main.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		happi.quittancement201901_0_1.Quittancement201901 childJob_tRunJob_1 = new happi.quittancement201901_0_1.Quittancement201901();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_2 = null;
		...
		happi.quittancement201902_0_1.Quittancement201902 childJob_tRunJob_2 = new happi.quittancement201902_0_1.Quittancement201902();
	    // pass DataSources
 ...
 */
    ...
    public static void main(String[] args){
        final Quittancement2019_main Quittancement2019_mainClass = new Quittancement2019_main();

        int exitCode = Quittancement2019_mainClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Quittancement2019_main.class.getClassLoader().getResourceAsStream("happi/quittancement2019_main_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Quittancement2019_main.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Quittancement2019_main");
        }
...
/************************************************************************************************
 *     39346 characters generated by Talend Open Studio for Data Integration 
 *     on the 30 mars 2021 10:55:18 CEST
 ************************************************************************************************/