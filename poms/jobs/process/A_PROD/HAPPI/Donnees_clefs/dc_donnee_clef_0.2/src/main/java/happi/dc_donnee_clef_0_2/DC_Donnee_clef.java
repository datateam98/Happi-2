...
package happi.dc_donnee_clef_0_2;
...
/**
 * Job: DC_Donnee_clef Purpose: Générer automatiquement les KPI pour Toucan des données clefs<br>
 * Description: Récupérer de l'infocentre et de datamart les données permettant la génération automatique des KPI dans l'outil Toucan toto sur l'application données clefs
Modification V0.2 : Modifications des dates dans "rotation" et "données clefs" pour embarquer plus de données <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class DC_Donnee_clef implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "DC_Donnee_clef";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				DC_Donnee_clef.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(DC_Donnee_clef.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 */
	...
	Object obj_tRunJob_3 = null;
		...
		happi.donnees_clefs_referentiel_tmp_0_1.Donnees_clefs_referentiel_tmp childJob_tRunJob_3 = new happi.donnees_clefs_referentiel_tmp_0_1.Donnees_clefs_referentiel_tmp();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		happi.happi_donnees_clefs_rotation_0_1.HAPPI_Donnees_clefs_Rotation childJob_tRunJob_1 = new happi.happi_donnees_clefs_rotation_0_1.HAPPI_Donnees_clefs_Rotation();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_2 = null;
		...
		happi.happi_donnees_clefs_livraison_0_1.HAPPI_Donnees_clefs_Livraison childJob_tRunJob_2 = new happi.happi_donnees_clefs_livraison_0_1.HAPPI_Donnees_clefs_Livraison();
	    // pass DataSources
 ...
 */
    ...
    public static void main(String[] args){
        final DC_Donnee_clef DC_Donnee_clefClass = new DC_Donnee_clef();

        int exitCode = DC_Donnee_clefClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = DC_Donnee_clef.class.getClassLoader().getResourceAsStream("happi/dc_donnee_clef_0_2/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = DC_Donnee_clef.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : DC_Donnee_clef");
        }
...
/************************************************************************************************
 *     42258 characters generated by Talend Open Studio for Data Integration 
