...
package happi.happi_pilotage_lna_0_5;
...
/**
 * Job: HAPPI_Pilotage_LNA Purpose: Suivre l'évolution du nbre de locataires non assuré<br>
 * Description: Permet de suivre le volume de locataires non assuré sur une période de temps ainsi que la courbe représentant le %  de locataire non assuré en fonction de la zone sélectionnée <br>
...
public void tDBConnection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:DuPKnA64ZXMBrTzzC5YXeQxY4NlHpfEq3IsHQw==");
...
String fileName_tFileOutputDelimited_5 = "";
    fileName_tFileOutputDelimited_5 = (new java.io.File("C:/Users/DKHUON/Desktop/HAPPI/FTPToucan/Pilotage/LNA_comptage.csv")).getAbsolutePath().replace("\\","/");
...
Var.VILLE = row10.VILLE != null ?
	(row10.VILLE.equals("SURESNES") ?
		(row9.CD_PATRIM1 == 3023 
		|| row9.CD_PATRIM1 == 3800
		|| row9.CD_PATRIM1 == 3804
		|| row9.CD_PATRIM1 == 3801
		|| row9.CD_PATRIM1 == 3802
		|| row9.CD_PATRIM1 == 3806
		|| row9.CD_PATRIM1 == 3024
		|| row9.CD_PATRIM1 == 3025
		|| row9.CD_PATRIM1 == 3701
		|| row9.CD_PATRIM1 == 3027
		|| row9.CD_PATRIM1 == 11013
		|| row9.CD_PATRIM1 == 11022
		|| row9.CD_PATRIM1 == 3803 
		|| row9.CD_PATRIM1 == 3700
		|| row9.CD_PATRIM1 == 3026 
...
if(copyOfout1 != null) { 
	...
	currentComponent="tFileOutputDelimited_5";
                    ...
                    StringBuilder sb_tFileOutputDelimited_5 = new StringBuilder();
                        ...
                        sb_tFileOutputDelimited_5.append(
                            copyOfout1.SocieteProprietaire
                        );
                            }
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row8";
		...
		int tos_count_tAdvancedHash_row8 = 0;
			   		...
			   		// source node:tDBInput_4 - inputs:(after_tDBInput_3) outputs:(row8,row8) | target node:tAdvancedHash_row8 - inputs:(row8) outputs:()
			   		// linked node: tMap_2 - inputs:(row8,row7) outputs:(out3)
 ...
 */
	...
	final String decryptedPassword_tDBInput_4 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:VmIMYJwoHicY5IOp6cc8+gOxlG9BCVhkRIzwjw==");
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row10";
		...
		int tos_count_tAdvancedHash_row10 = 0;
			   		...
			   		// source node:tDBInput_10 - inputs:(after_tDBInput_5) outputs:(row10,row10) | target node:tAdvancedHash_row10 - inputs:(row10) outputs:()
 ...
 */
	...
	final String decryptedPassword_tDBInput_10 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:eGHVAW4OoY1ZwoTe7pbC7bqn0W+VOET7cctWmg==");
...
String fileName_tFileOutputDelimited_2 = "";
    fileName_tFileOutputDelimited_2 = (new java.io.File("C:/Users/DKHUON/Desktop/HAPPI/FTPToucan/Pilotage/TDB_LNA.csv")).getAbsolutePath().replace("\\","/");
...
Var.VILLE = row8.VILLE != null ?
	(row8.VILLE.equals("SURESNES") ?
		(row7.CD_PATRIM1 == 3023 
		|| row7.CD_PATRIM1 == 3800
		|| row7.CD_PATRIM1 == 3804
		|| row7.CD_PATRIM1 == 3801
		|| row7.CD_PATRIM1 == 3802
		|| row7.CD_PATRIM1 == 3806
		|| row7.CD_PATRIM1 == 3024
		|| row7.CD_PATRIM1 == 3025
		|| row7.CD_PATRIM1 == 3701
		|| row7.CD_PATRIM1 == 3027
		|| row7.CD_PATRIM1 == 11013
		|| row7.CD_PATRIM1 == 11022
		|| row7.CD_PATRIM1 == 3803 
		|| row7.CD_PATRIM1 == 3700
		|| row7.CD_PATRIM1 == 3026 
		? "ANTENNE SURESNES" : "SURESNES (HORS ANTENNE)" ) 
	: row8.VILLE) : "-" ;// ###############################
        // ###############################
        // # Output tables
...
int connectionTimeout_tFTPConnection_1 = Integer.valueOf(0);
	...
	class MyTrust_tFTPConnection_1 {
		...
		throws java.security.KeyStoreException, java.security.NoSuchAlgorithmException, 
			...
			java.security.KeyStore ks = java.security.KeyStore.getInstance("JKS");
				...
				String decryptedKeyStorePassword_tFTPConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:ed2czRb34+ElZ+C9fLWHERSS/C2ic4fIyReQQL6NbY8=");
	...
	final String decryptedPassword_tFTPConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:ZxU0GZK+e8Rk0PixYLws3IHuHGRO4vtx4lOaXRpA+Gvv8+9g6NVfclG3SXw9VIF031c3yGKqvXlYIQkb");
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = HAPPI_Pilotage_LNA.class.getClassLoader().getResourceAsStream("happi/happi_pilotage_lna_0_5/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = HAPPI_Pilotage_LNA.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : HAPPI_Pilotage_LNA");
        }
...
/************************************************************************************************
 *     179737 characters generated by Talend Open Studio for Data Integration 
 *     on the 2 février 2023 15:11:42 CET
 ************************************************************************************************/