...
package happi.quittancement2019_0_1;
...
/**
 * Job: Quittancement2019 Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class Quittancement2019 implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "Quittancement2019";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Quittancement2019.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Quittancement2019.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public void tDBConnection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:k5VvkLRf/nGPivosR6HBROwS1uNxMODhY5oiKw==");
...
public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
    final static byte[] commonByteArrayLock_HAPPI_Quittancement2019 = new byte[0];
    static byte[] commonByteArray_HAPPI_Quittancement2019 = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_HAPPI_Quittancement2019.length) {
				if(length < 1024 && commonByteArray_HAPPI_Quittancement2019.length == 0) {
   					commonByteArray_HAPPI_Quittancement2019 = new byte[1024];
				} else {
   					commonByteArray_HAPPI_Quittancement2019 = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_HAPPI_Quittancement2019, 0, length);
			strReturn = new String(commonByteArray_HAPPI_Quittancement2019, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_HAPPI_Quittancement2019) {
...
+"RA_GIM.DT_ANNEE = 2019\n/*and (SID_FACTURA_GIM.DT_MOIS  = 1\nOR SID_FACTURA_GIM.DT_MOIS  = 2\nOR SID_FACTURA_GIM.DT_MOIS"
+"  = 3\nOR SID_FACTURA_GIM.DT_MOIS  = 4\nOR SID_FACTURA_GIM.DT_MOIS  = 5\nOR SID_FACTURA_GIM.DT_MOIS  = 6\nOR SID_FACTURA"
+"_GIM.DT_MOIS  = 7\nOR SID_FACTURA_GIM.DT_MOIS  = 8\nOR SID_FACTURA_GIM.DT_MOIS  = 9\nOR SID_FACTURA_GIM.DT_MOIS  = 10\nO"
+"R SID_FACTURA_GIM.DT_MOIS  = 11\nOR SID_FACTURA_GIM.DT_MOIS  = 12)*/\nand SID_FACTURA_GIM.SIO_CD_FAM_RUB='CHA'\n";
...
operation_finder_tAggregateRow_4.DT_MOIS = row5.DT_MOIS;
	...
	if(operation_result_tAggregateRow_4 == null) { // G_OutMain_AggR_001
		...
		operation_result_tAggregateRow_4.DT_MOIS = operation_finder_tAggregateRow_4.DT_MOIS;
 ...
 */
	...
	currentComponent="tFileOutputExcel_3";
		...
		String fileName_tFileOutputExcel_3="C:/Users/DKHUON/Desktop/HAPPI/Export/Quittancement 2019 par DF.xlsx";
 ...
 */
	...
	currentComponent="tAggregateRow_4_AGGIN";
            				    ...
            				    row7.NO_DOSFACT = aggregated_row_tAggregateRow_4.DT_MOIS;
 ...
 */
	...
	currentComponent="tFileOutputExcel_1";
		...
		String fileName_tFileOutputExcel_1="C:/Users/DKHUON/Desktop/HAPPI/Export/Quittancement 2019 par mois.xlsx";
 ...
 */
    ...
    public static void main(String[] args){
        final Quittancement2019 Quittancement2019Class = new Quittancement2019();

        int exitCode = Quittancement2019Class.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Quittancement2019.class.getClassLoader().getResourceAsStream("happi/quittancement2019_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Quittancement2019.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Quittancement2019");
        }
...
/************************************************************************************************
 *     137751 characters generated by Talend Open Studio for Data Integration 
 *     on the 30 mars 2021 10:55:01 CEST
 ************************************************************************************************/