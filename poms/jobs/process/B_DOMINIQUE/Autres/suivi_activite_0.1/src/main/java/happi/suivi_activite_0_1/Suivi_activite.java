...
package happi.suivi_activite_0_1;
...
/**
 * Job: Suivi_activite Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class Suivi_activite implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "Suivi_activite";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Suivi_activite.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Suivi_activite.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row6Struct implements routines.system.IPersistableRow<row6Struct> {
    final static byte[] commonByteArrayLock_HAPPI_Suivi_activite = new byte[0];
    static byte[] commonByteArray_HAPPI_Suivi_activite = new byte[0];

	
			    public java.util.Date Date_arrivee;
			    ...
			    public String Data_Analyst;

				public String getData_Analyst () {
					return this.Data_Analyst;
				}
				
			    public java.util.Date Date_de_debut_de_traitement;

				public java.util.Date getDate_de_debut_de_traitement () {
					return this.Date_de_debut_de_traitement;
				}
				
			    public Integer Delai_traitement;

				public Integer getDelai_traitement () {
					return this.Delai_traitement;
				}
				
			    public java.util.Date Date_de_livraison;

				public java.util.Date getDate_de_livraison () {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_HAPPI_Suivi_activite.length) {
				if(length < 1024 && commonByteArray_HAPPI_Suivi_activite.length == 0) {
   					commonByteArray_HAPPI_Suivi_activite = new byte[1024];
				} else {
   					commonByteArray_HAPPI_Suivi_activite = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_HAPPI_Suivi_activite, 0, length);
			strReturn = new String(commonByteArray_HAPPI_Suivi_activite, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_HAPPI_Suivi_activite) {

        	try {

        		int length = 0;
		
					this.Date_arrivee = readDate(dis);
					
					this.Service = readString(dis);
					
					this.Demandeur = readString(dis);
					
					this.Action = readString(dis);
					
					this.Statut = readString(dis);
					
						this.Complexite = readInteger(dis);
					
					this.Commentaire = readString(dis);
					
					this.Data_Analyst = readString(dis);
					
					this.Date_de_debut_de_traitement = readDate(dis);
					
						this.Delai_traitement = readInteger(dis);
					
					this.Date_de_livraison = readDate(dis);
					
					this.TYPE_ACTIVITE = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// java.util.Date
						...
						writeDate(this.Date_arrivee,dos);
					...
					// String
						...
						writeString(this.Demandeur,dos);
					...
					// Integer
						...
						writeInteger(this.Complexite,dos);
					...
					// String
						...
						writeString(this.Data_Analyst,dos);
					
					// java.util.Date
				
						writeDate(this.Date_de_debut_de_traitement,dos);
					
					// Integer
				
						writeInteger(this.Delai_traitement,dos);
					
					// java.util.Date
				
						writeDate(this.Date_de_livraison,dos);
					
					// String
				
						writeString(this.TYPE_ACTIVITE,dos);
    ...
    public String toString() {
		...
		sb.append("[");
		sb.append("Date_arrivee="+String.valueOf(Date_arrivee));
		sb.append(",Service="+Service);
		sb.append(",Demandeur="+Demandeur);
		sb.append(",Action="+Action);
		sb.append(",Statut="+Statut);
		sb.append(",Complexite="+String.valueOf(Complexite));
		sb.append(",Commentaire="+Commentaire);
		sb.append(",Data_Analyst="+Data_Analyst);
		sb.append(",Date_de_debut_de_traitement="+String.valueOf(Date_de_debut_de_traitement));
		sb.append(",Delai_traitement="+String.valueOf(Delai_traitement));
		sb.append(",Date_de_livraison="+String.valueOf(Date_de_livraison));
		sb.append(",TYPE_ACTIVITE="+TYPE_ACTIVITE);
	    sb.append("]");
...
String fileName_tFileOutputDelimited_5 = "";
    fileName_tFileOutputDelimited_5 = (new java.io.File("C:/Users/DKHUON/Desktop/HAPPI/FTPToucan/Suivi_Activite/Suivi_Act.csv")).getAbsolutePath().replace("\\","/");
                    ...
                    if(directory_tFileOutputDelimited_5 != null && directory_tFileOutputDelimited_5.trim().length() != 0) {
                        ...
                        new java.io.FileOutputStream(fileName_tFileOutputDelimited_5, false),"UTF-8"));
                                    if(filetFileOutputDelimited_5.length()==0){
                                        outtFileOutputDelimited_5.write("Date_arrivee");
                                            outtFileOutputDelimited_5.write(OUT_DELIM_tFileOutputDelimited_5);
                                        outtFileOutputDelimited_5.write("Service");
                                            outtFileOutputDelimited_5.write(OUT_DELIM_tFileOutputDelimited_5);
                                        outtFileOutputDelimited_5.write("Demandeur");
                                            outtFileOutputDelimited_5.write(OUT_DELIM_tFileOutputDelimited_5);
                                        outtFileOutputDelimited_5.write("Action");
                                            outtFileOutputDelimited_5.write(OUT_DELIM_tFileOutputDelimited_5);
                                        outtFileOutputDelimited_5.write("Statut");
                                            outtFileOutputDelimited_5.write(OUT_DELIM_tFileOutputDelimited_5);
                                        outtFileOutputDelimited_5.write("Complexite");
                                            outtFileOutputDelimited_5.write(OUT_DELIM_tFileOutputDelimited_5);
                                        outtFileOutputDelimited_5.write("Commentaire");
                                            outtFileOutputDelimited_5.write(OUT_DELIM_tFileOutputDelimited_5);
                                        outtFileOutputDelimited_5.write("Data_Analyst");
                                            outtFileOutputDelimited_5.write(OUT_DELIM_tFileOutputDelimited_5);
                                        outtFileOutputDelimited_5.write("Date_de_debut_de_traitement");
                                            outtFileOutputDelimited_5.write(OUT_DELIM_tFileOutputDelimited_5);
                                        outtFileOutputDelimited_5.write("Delai_traitement");
                                            outtFileOutputDelimited_5.write(OUT_DELIM_tFileOutputDelimited_5);
                                        outtFileOutputDelimited_5.write("Date_de_livraison");
                                            outtFileOutputDelimited_5.write(OUT_DELIM_tFileOutputDelimited_5);
                                        outtFileOutputDelimited_5.write("TYPE_ACTIVITE");
 ...
 */
	...
	currentComponent="tUnite_1";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"out1","out3","out4","out2");
					}
 ...
 */
	...
	final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:Dmo+CWVPLw8dJIbrlSGsRWVyiCr8D7Bgnu+c0w==");
		...
		Object source_tFileInputExcel_1 = "S:/Direction de la Maîtrise de la Performance/7- Suivi des demandes/Suivi des demandes Data - 2022.xlsx";
        ...
        sheetList_tFileInputExcel_1.addAll(regexUtil_tFileInputExcel_1.getSheets(workbook_tFileInputExcel_1, "Extractions ponctuelles", false));
	...
	if(sheetList_tFileInputExcel_1.size()>0){
        ...
        for(int i_tFileInputExcel_1 = begin_line_tFileInputExcel_1; i_tFileInputExcel_1 < end_line_tFileInputExcel_1; i_tFileInputExcel_1++){
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				curColName_tFileInputExcel_1 = "Date_arrivee";
				...
				if(0<actual_end_column_tFileInputExcel_1){
					try{
						if(row_tFileInputExcel_1.getCell(columnIndex_tFileInputExcel_1+ start_column_tFileInputExcel_1).getCellType() == org.apache.poi.ss.usermodel.CellType.NUMERIC && org.apache.poi.ss.usermodel.DateUtil.isCellDateFormatted(row_tFileInputExcel_1.getCell(columnIndex_tFileInputExcel_1+ start_column_tFileInputExcel_1))){
							row1.Date_arrivee = row_tFileInputExcel_1.getCell(columnIndex_tFileInputExcel_1+ start_column_tFileInputExcel_1).getDateCellValue();
						}
						else{
                            ...
                            if(tempDate_tFileInputExcel_1.after((new SimpleDateFormat("yyyy/MM/dd hh:mm:ss.SSS")).parse("9999/12/31 23:59:59.999"))||tempDate_tFileInputExcel_1.before((new SimpleDateFormat("yyyy/MM/dd")).parse("1900/01/01"))){
                                ...
                                row1.Date_arrivee = tempDate_tFileInputExcel_1;
                            }
						}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "Service";

				row1.Service = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				row1.Service = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "Demandeur";

				row1.Demandeur = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				row1.Demandeur = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "Action";

				row1.Action = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				row1.Action = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				...
				row1.Statut = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				row1.Statut = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "Complexite";

				row1.Complexite = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null, '.'==decimalChar_tFileInputExcel_1 ? null : decimalChar_tFileInputExcel_1));
			}else{
				row1.Complexite = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "Commentaire";

				row1.Commentaire = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				row1.Commentaire = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "Data_Analyst";

				row1.Data_Analyst = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
			}else{
				row1.Data_Analyst = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "Date_de_debut_de_traitement";

				if(8<actual_end_column_tFileInputExcel_1){
					try{
						if(row_tFileInputExcel_1.getCell(columnIndex_tFileInputExcel_1+ start_column_tFileInputExcel_1).getCellType() == org.apache.poi.ss.usermodel.CellType.NUMERIC && org.apache.poi.ss.usermodel.DateUtil.isCellDateFormatted(row_tFileInputExcel_1.getCell(columnIndex_tFileInputExcel_1+ start_column_tFileInputExcel_1))){
							row1.Date_de_debut_de_traitement = row_tFileInputExcel_1.getCell(columnIndex_tFileInputExcel_1+ start_column_tFileInputExcel_1).getDateCellValue();
						}
						else{
                            java.util.Date tempDate_tFileInputExcel_1 = ParserUtils.parseTo_Date(temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], "dd-MM-yyyy");
                            if(tempDate_tFileInputExcel_1.after((new SimpleDateFormat("yyyy/MM/dd hh:mm:ss.SSS")).parse("9999/12/31 23:59:59.999"))||tempDate_tFileInputExcel_1.before((new SimpleDateFormat("yyyy/MM/dd")).parse("1900/01/01"))){
                                ...
                                row1.Date_de_debut_de_traitement = tempDate_tFileInputExcel_1;
                            }
						}
					}catch(java.lang.Exception e){
				...
				row1.Date_de_debut_de_traitement = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "Delai_traitement";

				row1.Delai_traitement = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null, '.'==decimalChar_tFileInputExcel_1 ? null : decimalChar_tFileInputExcel_1));
			}else{
				row1.Delai_traitement = null;
				emptyColumnCount_tFileInputExcel_1++;
			}
			...
			if( temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
				curColNum_tFileInputExcel_1=columnIndex_tFileInputExcel_1 + start_column_tFileInputExcel_1 + 1;
				curColName_tFileInputExcel_1 = "Date_de_livraison";

				if(10<actual_end_column_tFileInputExcel_1){
					try{
						if(row_tFileInputExcel_1.getCell(columnIndex_tFileInputExcel_1+ start_column_tFileInputExcel_1).getCellType() == org.apache.poi.ss.usermodel.CellType.NUMERIC && org.apache.poi.ss.usermodel.DateUtil.isCellDateFormatted(row_tFileInputExcel_1.getCell(columnIndex_tFileInputExcel_1+ start_column_tFileInputExcel_1))){
							row1.Date_de_livraison = row_tFileInputExcel_1.getCell(columnIndex_tFileInputExcel_1+ start_column_tFileInputExcel_1).getDateCellValue();
						}
						else{
                            java.util.Date tempDate_tFileInputExcel_1 = ParserUtils.parseTo_Date(temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], "dd-MM-yyyy");
                            if(tempDate_tFileInputExcel_1.after((new SimpleDateFormat("yyyy/MM/dd hh:mm:ss.SSS")).parse("9999/12/31 23:59:59.999"))||tempDate_tFileInputExcel_1.before((new SimpleDateFormat("yyyy/MM/dd")).parse("1900/01/01"))){
                                ...
                                row1.Date_de_livraison = tempDate_tFileInputExcel_1;
                            }
						}
					}catch(java.lang.Exception e){
...
row1.Service  != null || row1.Demandeur != null

 ) {
out1_tmp.Date_arrivee = row1.Date_arrivee ;
out1_tmp.Service = row1.Service ;
out1_tmp.Demandeur = row1.Demandeur ;
out1_tmp.Action = row1.Action ;
out1_tmp.Statut = row1.Statut ;
out1_tmp.Complexite = row1.Complexite ;
out1_tmp.Commentaire = row1.Commentaire ;
out1_tmp.Data_Analyst = row1.Data_Analyst ;
out1_tmp.Date_de_debut_de_traitement = row1.Date_de_debut_de_traitement ;
out1_tmp.Delai_traitement = row1.Delai_traitement ;
out1_tmp.Date_de_livraison = row1.Date_de_livraison ;
out1_tmp.TYPE_ACTIVITE = "Extraction ponctuelle";
out1 = out1_tmp;
...
// for output
			...
			row6.Date_arrivee = out1.Date_arrivee;								
			row6.Service = out1.Service;								
			row6.Demandeur = out1.Demandeur;								
			row6.Action = out1.Action;								
			row6.Statut = out1.Statut;								
			row6.Complexite = out1.Complexite;								
			row6.Commentaire = out1.Commentaire;								
			row6.Data_Analyst = out1.Data_Analyst;								
			row6.Date_de_debut_de_traitement = out1.Date_de_debut_de_traitement;								
			row6.Delai_traitement = out1.Delai_traitement;								
			row6.Date_de_livraison = out1.Date_de_livraison;								
			row6.TYPE_ACTIVITE = out1.TYPE_ACTIVITE;			
 ...
 */
	...
	currentComponent="tFileOutputDelimited_5";
                    ...
                    StringBuilder sb_tFileOutputDelimited_5 = new StringBuilder();
                            if(row6.Date_arrivee != null) {
                        sb_tFileOutputDelimited_5.append(
                            FormatterUtils.format_Date(row6.Date_arrivee, "dd-MM-yyyy")
                        );
                            }
                            sb_tFileOutputDelimited_5.append(OUT_DELIM_tFileOutputDelimited_5);
                            if(row6.Service != null) {
                        sb_tFileOutputDelimited_5.append(
                            row6.Service
                        );
                            }
                            sb_tFileOutputDelimited_5.append(OUT_DELIM_tFileOutputDelimited_5);
                            if(row6.Demandeur != null) {
                        sb_tFileOutputDelimited_5.append(
                            row6.Demandeur
                        );
                            }
                        ...
                        sb_tFileOutputDelimited_5.append(
                            ...
                            sb_tFileOutputDelimited_5.append(OUT_DELIM_tFileOutputDelimited_5);
                            if(row6.Complexite != null) {
                        sb_tFileOutputDelimited_5.append(
                            row6.Complexite
                        );
                            }
                            sb_tFileOutputDelimited_5.append(OUT_DELIM_tFileOutputDelimited_5);
                            if(row6.Commentaire != null) {
                        sb_tFileOutputDelimited_5.append(
                            row6.Commentaire
                        );
                            }
                            sb_tFileOutputDelimited_5.append(OUT_DELIM_tFileOutputDelimited_5);
                            if(row6.Data_Analyst != null) {
                        sb_tFileOutputDelimited_5.append(
                            row6.Data_Analyst
                        );
                            }
                            sb_tFileOutputDelimited_5.append(OUT_DELIM_tFileOutputDelimited_5);
                            if(row6.Date_de_debut_de_traitement != null) {
                        sb_tFileOutputDelimited_5.append(
                            FormatterUtils.format_Date(row6.Date_de_debut_de_traitement, "dd-MM-yyyy")
                        );
                            }
                            sb_tFileOutputDelimited_5.append(OUT_DELIM_tFileOutputDelimited_5);
                            if(row6.Delai_traitement != null) {
                        sb_tFileOutputDelimited_5.append(
                            row6.Delai_traitement
                        );
                            }
                            sb_tFileOutputDelimited_5.append(OUT_DELIM_tFileOutputDelimited_5);
                            if(row6.Date_de_livraison != null) {
                        sb_tFileOutputDelimited_5.append(
                            FormatterUtils.format_Date(row6.Date_de_livraison, "dd-MM-yyyy")
                        );
                            }
                            sb_tFileOutputDelimited_5.append(OUT_DELIM_tFileOutputDelimited_5);
                            if(row6.TYPE_ACTIVITE != null) {
                        sb_tFileOutputDelimited_5.append(
                            row6.TYPE_ACTIVITE
                        );
                            }
 ...
 */
	...
	final String decryptedPassword_tFileInputExcel_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:UENI0evxLfiYgKPkikqzfG2ytAbBRttGouuKMw==");
		...
		Object source_tFileInputExcel_2 = "S:/Direction de la Maîtrise de la Performance/7- Suivi des demandes/Suivi des demandes Data - 2022.xlsx";
        ...
        sheetList_tFileInputExcel_2.addAll(regexUtil_tFileInputExcel_2.getSheets(workbook_tFileInputExcel_2, "Extractions récurrentes", false));
	...
	if(sheetList_tFileInputExcel_2.size()>0){
        ...
        for(int i_tFileInputExcel_2 = begin_line_tFileInputExcel_2; i_tFileInputExcel_2 < end_line_tFileInputExcel_2; i_tFileInputExcel_2++){
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				...
				curColName_tFileInputExcel_2 = "Date_arrivee";

				if(0<actual_end_column_tFileInputExcel_2){
					try{
						if(row_tFileInputExcel_2.getCell(columnIndex_tFileInputExcel_2+ start_column_tFileInputExcel_2).getCellType() == org.apache.poi.ss.usermodel.CellType.NUMERIC && org.apache.poi.ss.usermodel.DateUtil.isCellDateFormatted(row_tFileInputExcel_2.getCell(columnIndex_tFileInputExcel_2+ start_column_tFileInputExcel_2))){
							row2.Date_arrivee = row_tFileInputExcel_2.getCell(columnIndex_tFileInputExcel_2+ start_column_tFileInputExcel_2).getDateCellValue();
						}
						else{
                            ...
                            if(tempDate_tFileInputExcel_2.after((new SimpleDateFormat("yyyy/MM/dd hh:mm:ss.SSS")).parse("9999/12/31 23:59:59.999"))||tempDate_tFileInputExcel_2.before((new SimpleDateFormat("yyyy/MM/dd")).parse("1900/01/01"))){
                                ...
                                row2.Date_arrivee = tempDate_tFileInputExcel_2;
                            }
						}
					}catch(java.lang.Exception e){
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "Service";

				row2.Service = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row2.Service = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "Demandeur";

				row2.Demandeur = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row2.Demandeur = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "Action";

				row2.Action = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row2.Action = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				...
				row2.Statut = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row2.Statut = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "Complexite";

				row2.Complexite = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2], null, '.'==decimalChar_tFileInputExcel_2 ? null : decimalChar_tFileInputExcel_2));
			}else{
				row2.Complexite = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "Commentaire";

				row2.Commentaire = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "Data_Analyst";

				row2.Data_Analyst = temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2];
			}else{
				row2.Data_Analyst = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "Date_de_debut_de_traitement";

				if(8<actual_end_column_tFileInputExcel_2){
					try{
						if(row_tFileInputExcel_2.getCell(columnIndex_tFileInputExcel_2+ start_column_tFileInputExcel_2).getCellType() == org.apache.poi.ss.usermodel.CellType.NUMERIC && org.apache.poi.ss.usermodel.DateUtil.isCellDateFormatted(row_tFileInputExcel_2.getCell(columnIndex_tFileInputExcel_2+ start_column_tFileInputExcel_2))){
							row2.Date_de_debut_de_traitement = row_tFileInputExcel_2.getCell(columnIndex_tFileInputExcel_2+ start_column_tFileInputExcel_2).getDateCellValue();
						}
						else{
                            java.util.Date tempDate_tFileInputExcel_2 = ParserUtils.parseTo_Date(temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2], "dd-MM-yyyy");
                            if(tempDate_tFileInputExcel_2.after((new SimpleDateFormat("yyyy/MM/dd hh:mm:ss.SSS")).parse("9999/12/31 23:59:59.999"))||tempDate_tFileInputExcel_2.before((new SimpleDateFormat("yyyy/MM/dd")).parse("1900/01/01"))){
                                ...
                                row2.Date_de_debut_de_traitement = tempDate_tFileInputExcel_2;
                            }
						}
					}catch(java.lang.Exception e){
				...
				row2.Date_de_debut_de_traitement = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "Delai_traitement";

				row2.Delai_traitement = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2], null, '.'==decimalChar_tFileInputExcel_2 ? null : decimalChar_tFileInputExcel_2));
			}else{
				row2.Delai_traitement = null;
				emptyColumnCount_tFileInputExcel_2++;
			}
			...
			if( temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2].length() > 0) {
				curColNum_tFileInputExcel_2=columnIndex_tFileInputExcel_2 + start_column_tFileInputExcel_2 + 1;
				curColName_tFileInputExcel_2 = "Date_de_livraison";

				if(10<actual_end_column_tFileInputExcel_2){
					try{
						if(row_tFileInputExcel_2.getCell(columnIndex_tFileInputExcel_2+ start_column_tFileInputExcel_2).getCellType() == org.apache.poi.ss.usermodel.CellType.NUMERIC && org.apache.poi.ss.usermodel.DateUtil.isCellDateFormatted(row_tFileInputExcel_2.getCell(columnIndex_tFileInputExcel_2+ start_column_tFileInputExcel_2))){
							row2.Date_de_livraison = row_tFileInputExcel_2.getCell(columnIndex_tFileInputExcel_2+ start_column_tFileInputExcel_2).getDateCellValue();
						}
						else{
                            java.util.Date tempDate_tFileInputExcel_2 = ParserUtils.parseTo_Date(temp_row_tFileInputExcel_2[columnIndex_tFileInputExcel_2], "dd-MM-yyyy");
                            if(tempDate_tFileInputExcel_2.after((new SimpleDateFormat("yyyy/MM/dd hh:mm:ss.SSS")).parse("9999/12/31 23:59:59.999"))||tempDate_tFileInputExcel_2.before((new SimpleDateFormat("yyyy/MM/dd")).parse("1900/01/01"))){
                                ...
                                row2.Date_de_livraison = tempDate_tFileInputExcel_2;
                            }
						}
					}catch(java.lang.Exception e){
...
row2.Service  != null || row2.Demandeur != null

 ) {
out2_tmp.Date_arrivee = row2.Date_arrivee ;
out2_tmp.Service = row2.Service ;
out2_tmp.Demandeur = row2.Demandeur ;
out2_tmp.Action = row2.Action ;
out2_tmp.Statut = row2.Statut ;
out2_tmp.Complexite = row2.Complexite ;
out2_tmp.Commentaire = row2.Commentaire ;
out2_tmp.Data_Analyst = row2.Data_Analyst ;
out2_tmp.Date_de_debut_de_traitement = row2.Date_de_debut_de_traitement ;
out2_tmp.Delai_traitement = row2.Delai_traitement ;
out2_tmp.Date_de_livraison = row2.Date_de_livraison ;
out2_tmp.TYPE_ACTIVITE = "Extraction récurrente";
out2 = out2_tmp;
} // closing filter/reject
// ###############################
...
// for output
			...
			row6.Date_arrivee = out2.Date_arrivee;								
			row6.Service = out2.Service;								
			row6.Demandeur = out2.Demandeur;								
			row6.Action = out2.Action;								
			row6.Statut = out2.Statut;								
			row6.Complexite = out2.Complexite;								
			row6.Commentaire = out2.Commentaire;								
			row6.Data_Analyst = out2.Data_Analyst;								
			row6.Date_de_debut_de_traitement = out2.Date_de_debut_de_traitement;								
			row6.Delai_traitement = out2.Delai_traitement;								
			row6.Date_de_livraison = out2.Date_de_livraison;								
			row6.TYPE_ACTIVITE = out2.TYPE_ACTIVITE;			
 ...
 */
	...
	final String decryptedPassword_tFileInputExcel_3 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:Kizmtgh189S/IW2wTsOLMITgxFBZz8Vxdz9czA==");
		...
		Object source_tFileInputExcel_3 = "S:/Direction de la Maîtrise de la Performance/7- Suivi des demandes/Suivi des demandes Data - 2022.xlsx";
        ...
        sheetList_tFileInputExcel_3.addAll(regexUtil_tFileInputExcel_3.getSheets(workbook_tFileInputExcel_3, "Projets", false));
	...
	if(sheetList_tFileInputExcel_3.size()>0){
        ...
        for(int i_tFileInputExcel_3 = begin_line_tFileInputExcel_3; i_tFileInputExcel_3 < end_line_tFileInputExcel_3; i_tFileInputExcel_3++){
			...
			if( temp_row_tFileInputExcel_3[columnIndex_tFileInputExcel_3].length() > 0) {
				...
				curColName_tFileInputExcel_3 = "Date_arrivee";

				if(0<actual_end_column_tFileInputExcel_3){
					try{
						if(row_tFileInputExcel_3.getCell(columnIndex_tFileInputExcel_3+ start_column_tFileInputExcel_3).getCellType() == org.apache.poi.ss.usermodel.CellType.NUMERIC && org.apache.poi.ss.usermodel.DateUtil.isCellDateFormatted(row_tFileInputExcel_3.getCell(columnIndex_tFileInputExcel_3+ start_column_tFileInputExcel_3))){
							row3.Date_arrivee = row_tFileInputExcel_3.getCell(columnIndex_tFileInputExcel_3+ start_column_tFileInputExcel_3).getDateCellValue();
						}
						else{
                            java.util.Date tempDate_tFileInputExcel_3 = ParserUtils.parseTo_Date(temp_row_tFileInputExcel_3[columnIndex_tFileInputExcel_3], "dd-MM-yyyy");
                            if(tempDate_tFileInputExcel_3.after((new SimpleDateFormat("yyyy/MM/dd hh:mm:ss.SSS")).parse("9999/12/31 23:59:59.999"))||tempDate_tFileInputExcel_3.before((new SimpleDateFormat("yyyy/MM/dd")).parse("1900/01/01"))){
                                ...
                                row3.Date_arrivee = tempDate_tFileInputExcel_3;
                            }
						}
					}catch(java.lang.Exception e){
			...
			if( temp_row_tFileInputExcel_3[columnIndex_tFileInputExcel_3].length() > 0) {
				curColNum_tFileInputExcel_3=columnIndex_tFileInputExcel_3 + start_column_tFileInputExcel_3 + 1;
				curColName_tFileInputExcel_3 = "Service";

				row3.Service = temp_row_tFileInputExcel_3[columnIndex_tFileInputExcel_3];
			}else{
				row3.Service = null;
				emptyColumnCount_tFileInputExcel_3++;
			}
			...
			if( temp_row_tFileInputExcel_3[columnIndex_tFileInputExcel_3].length() > 0) {
				curColNum_tFileInputExcel_3=columnIndex_tFileInputExcel_3 + start_column_tFileInputExcel_3 + 1;
				curColName_tFileInputExcel_3 = "Demandeur";

				row3.Demandeur = temp_row_tFileInputExcel_3[columnIndex_tFileInputExcel_3];
			}else{
				row3.Demandeur = null;
				emptyColumnCount_tFileInputExcel_3++;
			}
			...
			if( temp_row_tFileInputExcel_3[columnIndex_tFileInputExcel_3].length() > 0) {
				curColNum_tFileInputExcel_3=columnIndex_tFileInputExcel_3 + start_column_tFileInputExcel_3 + 1;
				curColName_tFileInputExcel_3 = "Action";

				row3.Action = temp_row_tFileInputExcel_3[columnIndex_tFileInputExcel_3];
			}else{
				row3.Action = null;
				emptyColumnCount_tFileInputExcel_3++;
			}
			...
			if( temp_row_tFileInputExcel_3[columnIndex_tFileInputExcel_3].length() > 0) {
				curColNum_tFileInputExcel_3=columnIndex_tFileInputExcel_3 + start_column_tFileInputExcel_3 + 1;
				curColName_tFileInputExcel_3 = "Statut";

				row3.Statut = temp_row_tFileInputExcel_3[columnIndex_tFileInputExcel_3];
			}else{
				row3.Statut = null;
				emptyColumnCount_tFileInputExcel_3++;
			}
			...
			if( temp_row_tFileInputExcel_3[columnIndex_tFileInputExcel_3].length() > 0) {
				curColNum_tFileInputExcel_3=columnIndex_tFileInputExcel_3 + start_column_tFileInputExcel_3 + 1;
				curColName_tFileInputExcel_3 = "Complexite";

				row3.Complexite = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(temp_row_tFileInputExcel_3[columnIndex_tFileInputExcel_3], null, '.'==decimalChar_tFileInputExcel_3 ? null : decimalChar_tFileInputExcel_3));
			}else{
				row3.Complexite = null;
				emptyColumnCount_tFileInputExcel_3++;
			}
			...
			if( temp_row_tFileInputExcel_3[columnIndex_tFileInputExcel_3].length() > 0) {
				curColNum_tFileInputExcel_3=columnIndex_tFileInputExcel_3 + start_column_tFileInputExcel_3 + 1;
				curColName_tFileInputExcel_3 = "Commentaire";

				row3.Commentaire = temp_row_tFileInputExcel_3[columnIndex_tFileInputExcel_3];
			}else{
				row3.Commentaire = null;
				emptyColumnCount_tFileInputExcel_3++;
			}
			...
			if( temp_row_tFileInputExcel_3[columnIndex_tFileInputExcel_3].length() > 0) {
				curColNum_tFileInputExcel_3=columnIndex_tFileInputExcel_3 + start_column_tFileInputExcel_3 + 1;
				curColName_tFileInputExcel_3 = "Data_Analyst";

				row3.Data_Analyst = temp_row_tFileInputExcel_3[columnIndex_tFileInputExcel_3];
			}else{
				row3.Data_Analyst = null;
				emptyColumnCount_tFileInputExcel_3++;
			}
			...
			if( temp_row_tFileInputExcel_3[columnIndex_tFileInputExcel_3].length() > 0) {
				curColNum_tFileInputExcel_3=columnIndex_tFileInputExcel_3 + start_column_tFileInputExcel_3 + 1;
				curColName_tFileInputExcel_3 = "Date_de_debut_de_traitement";

				if(8<actual_end_column_tFileInputExcel_3){
					try{
						if(row_tFileInputExcel_3.getCell(columnIndex_tFileInputExcel_3+ start_column_tFileInputExcel_3).getCellType() == org.apache.poi.ss.usermodel.CellType.NUMERIC && org.apache.poi.ss.usermodel.DateUtil.isCellDateFormatted(row_tFileInputExcel_3.getCell(columnIndex_tFileInputExcel_3+ start_column_tFileInputExcel_3))){
							row3.Date_de_debut_de_traitement = row_tFileInputExcel_3.getCell(columnIndex_tFileInputExcel_3+ start_column_tFileInputExcel_3).getDateCellValue();
						}
						else{
                            java.util.Date tempDate_tFileInputExcel_3 = ParserUtils.parseTo_Date(temp_row_tFileInputExcel_3[columnIndex_tFileInputExcel_3], "dd-MM-yyyy");
                            if(tempDate_tFileInputExcel_3.after((new SimpleDateFormat("yyyy/MM/dd hh:mm:ss.SSS")).parse("9999/12/31 23:59:59.999"))||tempDate_tFileInputExcel_3.before((new SimpleDateFormat("yyyy/MM/dd")).parse("1900/01/01"))){
                                ...
                                row3.Date_de_debut_de_traitement = tempDate_tFileInputExcel_3;
                            }
						}
					}catch(java.lang.Exception e){
				...
				row3.Date_de_debut_de_traitement = null;
				emptyColumnCount_tFileInputExcel_3++;
			}
			...
			if( temp_row_tFileInputExcel_3[columnIndex_tFileInputExcel_3].length() > 0) {
				curColNum_tFileInputExcel_3=columnIndex_tFileInputExcel_3 + start_column_tFileInputExcel_3 + 1;
				curColName_tFileInputExcel_3 = "Delai_traitement";

				row3.Delai_traitement = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(temp_row_tFileInputExcel_3[columnIndex_tFileInputExcel_3], null, '.'==decimalChar_tFileInputExcel_3 ? null : decimalChar_tFileInputExcel_3));
			}else{
				row3.Delai_traitement = null;
				emptyColumnCount_tFileInputExcel_3++;
			}
			...
			if( temp_row_tFileInputExcel_3[columnIndex_tFileInputExcel_3].length() > 0) {
				curColNum_tFileInputExcel_3=columnIndex_tFileInputExcel_3 + start_column_tFileInputExcel_3 + 1;
				curColName_tFileInputExcel_3 = "Date_de_livraison";

				if(10<actual_end_column_tFileInputExcel_3){
					try{
						if(row_tFileInputExcel_3.getCell(columnIndex_tFileInputExcel_3+ start_column_tFileInputExcel_3).getCellType() == org.apache.poi.ss.usermodel.CellType.NUMERIC && org.apache.poi.ss.usermodel.DateUtil.isCellDateFormatted(row_tFileInputExcel_3.getCell(columnIndex_tFileInputExcel_3+ start_column_tFileInputExcel_3))){
							row3.Date_de_livraison = row_tFileInputExcel_3.getCell(columnIndex_tFileInputExcel_3+ start_column_tFileInputExcel_3).getDateCellValue();
						}
						else{
                            java.util.Date tempDate_tFileInputExcel_3 = ParserUtils.parseTo_Date(temp_row_tFileInputExcel_3[columnIndex_tFileInputExcel_3], "dd-MM-yyyy");
                            if(tempDate_tFileInputExcel_3.after((new SimpleDateFormat("yyyy/MM/dd hh:mm:ss.SSS")).parse("9999/12/31 23:59:59.999"))||tempDate_tFileInputExcel_3.before((new SimpleDateFormat("yyyy/MM/dd")).parse("1900/01/01"))){
                                ...
                                row3.Date_de_livraison = tempDate_tFileInputExcel_3;
                            }
						}
					}catch(java.lang.Exception e){
...
row3.Service  != null || row3.Demandeur != null

 ) {
out3_tmp.Date_arrivee = row3.Date_arrivee ;
out3_tmp.Service = row3.Service ;
out3_tmp.Demandeur = row3.Demandeur ;
out3_tmp.Action = row3.Action ;
out3_tmp.Statut = row3.Statut ;
out3_tmp.Complexite = row3.Complexite ;
out3_tmp.Commentaire = row3.Commentaire ;
out3_tmp.Data_Analyst = row3.Data_Analyst ;
out3_tmp.Date_de_debut_de_traitement = row3.Date_de_debut_de_traitement ;
out3_tmp.Delai_traitement = row3.Delai_traitement ;
out3_tmp.Date_de_livraison = row3.Date_de_livraison ;
out3_tmp.TYPE_ACTIVITE = "Projets";
out3 = out3_tmp;
} // closing filter/reject
// ###############################
...
// for output
			...
			row6.Date_arrivee = out3.Date_arrivee;								
			row6.Service = out3.Service;								
			row6.Demandeur = out3.Demandeur;								
			row6.Action = out3.Action;								
			row6.Statut = out3.Statut;								
			row6.Complexite = out3.Complexite;								
			row6.Commentaire = out3.Commentaire;								
			row6.Data_Analyst = out3.Data_Analyst;								
			row6.Date_de_debut_de_traitement = out3.Date_de_debut_de_traitement;								
			row6.Delai_traitement = out3.Delai_traitement;								
			row6.Date_de_livraison = out3.Date_de_livraison;								
			row6.TYPE_ACTIVITE = out3.TYPE_ACTIVITE;			
 ...
 */
	...
	final String decryptedPassword_tFileInputExcel_4 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:dhi7HVQxgaRxvcsVRnJvQ3wJvB3bFhDt8j50nw==");
		...
		Object source_tFileInputExcel_4 = "S:/Direction de la Maîtrise de la Performance/7- Suivi des demandes/Suivi des demandes Data - 2022.xlsx";
        ...
        sheetList_tFileInputExcel_4.addAll(regexUtil_tFileInputExcel_4.getSheets(workbook_tFileInputExcel_4, "Maintenance & Docs", false));
	...
	if(sheetList_tFileInputExcel_4.size()>0){
        ...
        int begin_line_tFileInputExcel_4 = 4;
        ...
        for(int i_tFileInputExcel_4 = begin_line_tFileInputExcel_4; i_tFileInputExcel_4 < end_line_tFileInputExcel_4; i_tFileInputExcel_4++){
			...
			if( temp_row_tFileInputExcel_4[columnIndex_tFileInputExcel_4].length() > 0) {
				...
				curColName_tFileInputExcel_4 = "Date_arrivee";

				if(0<actual_end_column_tFileInputExcel_4){
					try{
						if(row_tFileInputExcel_4.getCell(columnIndex_tFileInputExcel_4+ start_column_tFileInputExcel_4).getCellType() == org.apache.poi.ss.usermodel.CellType.NUMERIC && org.apache.poi.ss.usermodel.DateUtil.isCellDateFormatted(row_tFileInputExcel_4.getCell(columnIndex_tFileInputExcel_4+ start_column_tFileInputExcel_4))){
							row4.Date_arrivee = row_tFileInputExcel_4.getCell(columnIndex_tFileInputExcel_4+ start_column_tFileInputExcel_4).getDateCellValue();
						}
						else{
                            ...
                            if(tempDate_tFileInputExcel_4.after((new SimpleDateFormat("yyyy/MM/dd hh:mm:ss.SSS")).parse("9999/12/31 23:59:59.999"))||tempDate_tFileInputExcel_4.before((new SimpleDateFormat("yyyy/MM/dd")).parse("1900/01/01"))){
                                ...
                                row4.Date_arrivee = tempDate_tFileInputExcel_4;
                            }
						}
					}catch(java.lang.Exception e){
			...
			if( temp_row_tFileInputExcel_4[columnIndex_tFileInputExcel_4].length() > 0) {
				curColNum_tFileInputExcel_4=columnIndex_tFileInputExcel_4 + start_column_tFileInputExcel_4 + 1;
				curColName_tFileInputExcel_4 = "Service";

				row4.Service = temp_row_tFileInputExcel_4[columnIndex_tFileInputExcel_4];
			}else{
				row4.Service = null;
				emptyColumnCount_tFileInputExcel_4++;
			}
			...
			if( temp_row_tFileInputExcel_4[columnIndex_tFileInputExcel_4].length() > 0) {
				curColNum_tFileInputExcel_4=columnIndex_tFileInputExcel_4 + start_column_tFileInputExcel_4 + 1;
				curColName_tFileInputExcel_4 = "Demandeur";

				row4.Demandeur = temp_row_tFileInputExcel_4[columnIndex_tFileInputExcel_4];
			}else{
				row4.Demandeur = null;
				emptyColumnCount_tFileInputExcel_4++;
			}
			...
			if( temp_row_tFileInputExcel_4[columnIndex_tFileInputExcel_4].length() > 0) {
				curColNum_tFileInputExcel_4=columnIndex_tFileInputExcel_4 + start_column_tFileInputExcel_4 + 1;
				curColName_tFileInputExcel_4 = "Action";

				row4.Action = temp_row_tFileInputExcel_4[columnIndex_tFileInputExcel_4];
			}else{
				row4.Action = null;
				emptyColumnCount_tFileInputExcel_4++;
			}
			...
			if( temp_row_tFileInputExcel_4[columnIndex_tFileInputExcel_4].length() > 0) {
				curColNum_tFileInputExcel_4=columnIndex_tFileInputExcel_4 + start_column_tFileInputExcel_4 + 1;
				curColName_tFileInputExcel_4 = "Statut";

				row4.Statut = temp_row_tFileInputExcel_4[columnIndex_tFileInputExcel_4];
			}else{
				row4.Statut = null;
				emptyColumnCount_tFileInputExcel_4++;
			}
			...
			if( temp_row_tFileInputExcel_4[columnIndex_tFileInputExcel_4].length() > 0) {
				curColNum_tFileInputExcel_4=columnIndex_tFileInputExcel_4 + start_column_tFileInputExcel_4 + 1;
				curColName_tFileInputExcel_4 = "Complexite";

				row4.Complexite = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(temp_row_tFileInputExcel_4[columnIndex_tFileInputExcel_4], null, '.'==decimalChar_tFileInputExcel_4 ? null : decimalChar_tFileInputExcel_4));
			}else{
				row4.Complexite = null;
				emptyColumnCount_tFileInputExcel_4++;
			}
			...
			if( temp_row_tFileInputExcel_4[columnIndex_tFileInputExcel_4].length() > 0) {
				curColNum_tFileInputExcel_4=columnIndex_tFileInputExcel_4 + start_column_tFileInputExcel_4 + 1;
				curColName_tFileInputExcel_4 = "Commentaire";

				row4.Commentaire = temp_row_tFileInputExcel_4[columnIndex_tFileInputExcel_4];
			}else{
			...
			if( temp_row_tFileInputExcel_4[columnIndex_tFileInputExcel_4].length() > 0) {
				curColNum_tFileInputExcel_4=columnIndex_tFileInputExcel_4 + start_column_tFileInputExcel_4 + 1;
				curColName_tFileInputExcel_4 = "Data_Analyst";

				row4.Data_Analyst = temp_row_tFileInputExcel_4[columnIndex_tFileInputExcel_4];
			}else{
				row4.Data_Analyst = null;
				emptyColumnCount_tFileInputExcel_4++;
			}
			...
			if( temp_row_tFileInputExcel_4[columnIndex_tFileInputExcel_4].length() > 0) {
				curColNum_tFileInputExcel_4=columnIndex_tFileInputExcel_4 + start_column_tFileInputExcel_4 + 1;
				curColName_tFileInputExcel_4 = "Date_de_debut_de_traitement";

				if(8<actual_end_column_tFileInputExcel_4){
					try{
						if(row_tFileInputExcel_4.getCell(columnIndex_tFileInputExcel_4+ start_column_tFileInputExcel_4).getCellType() == org.apache.poi.ss.usermodel.CellType.NUMERIC && org.apache.poi.ss.usermodel.DateUtil.isCellDateFormatted(row_tFileInputExcel_4.getCell(columnIndex_tFileInputExcel_4+ start_column_tFileInputExcel_4))){
							row4.Date_de_debut_de_traitement = row_tFileInputExcel_4.getCell(columnIndex_tFileInputExcel_4+ start_column_tFileInputExcel_4).getDateCellValue();
						}
						else{
                            java.util.Date tempDate_tFileInputExcel_4 = ParserUtils.parseTo_Date(temp_row_tFileInputExcel_4[columnIndex_tFileInputExcel_4], "dd-MM-yyyy");
                            if(tempDate_tFileInputExcel_4.after((new SimpleDateFormat("yyyy/MM/dd hh:mm:ss.SSS")).parse("9999/12/31 23:59:59.999"))||tempDate_tFileInputExcel_4.before((new SimpleDateFormat("yyyy/MM/dd")).parse("1900/01/01"))){
                                ...
                                row4.Date_de_debut_de_traitement = tempDate_tFileInputExcel_4;
                            }
						}
					}catch(java.lang.Exception e){
				...
				row4.Date_de_debut_de_traitement = null;
				emptyColumnCount_tFileInputExcel_4++;
			}
			...
			if( temp_row_tFileInputExcel_4[columnIndex_tFileInputExcel_4].length() > 0) {
				curColNum_tFileInputExcel_4=columnIndex_tFileInputExcel_4 + start_column_tFileInputExcel_4 + 1;
				curColName_tFileInputExcel_4 = "Delai_traitement";

				row4.Delai_traitement = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(temp_row_tFileInputExcel_4[columnIndex_tFileInputExcel_4], null, '.'==decimalChar_tFileInputExcel_4 ? null : decimalChar_tFileInputExcel_4));
			}else{
				row4.Delai_traitement = null;
				emptyColumnCount_tFileInputExcel_4++;
			}
			...
			if( temp_row_tFileInputExcel_4[columnIndex_tFileInputExcel_4].length() > 0) {
				curColNum_tFileInputExcel_4=columnIndex_tFileInputExcel_4 + start_column_tFileInputExcel_4 + 1;
				curColName_tFileInputExcel_4 = "Date_de_livraison";

				if(10<actual_end_column_tFileInputExcel_4){
					try{
						if(row_tFileInputExcel_4.getCell(columnIndex_tFileInputExcel_4+ start_column_tFileInputExcel_4).getCellType() == org.apache.poi.ss.usermodel.CellType.NUMERIC && org.apache.poi.ss.usermodel.DateUtil.isCellDateFormatted(row_tFileInputExcel_4.getCell(columnIndex_tFileInputExcel_4+ start_column_tFileInputExcel_4))){
							row4.Date_de_livraison = row_tFileInputExcel_4.getCell(columnIndex_tFileInputExcel_4+ start_column_tFileInputExcel_4).getDateCellValue();
						}
						else{
                            java.util.Date tempDate_tFileInputExcel_4 = ParserUtils.parseTo_Date(temp_row_tFileInputExcel_4[columnIndex_tFileInputExcel_4], "dd-MM-yyyy");
                            if(tempDate_tFileInputExcel_4.after((new SimpleDateFormat("yyyy/MM/dd hh:mm:ss.SSS")).parse("9999/12/31 23:59:59.999"))||tempDate_tFileInputExcel_4.before((new SimpleDateFormat("yyyy/MM/dd")).parse("1900/01/01"))){
                                ...
                                row4.Date_de_livraison = tempDate_tFileInputExcel_4;
                            }
						}
					}catch(java.lang.Exception e){
...
row4.Service  != null || row4.Demandeur != null

 ) {
out4_tmp.Date_arrivee = row4.Date_arrivee ;
out4_tmp.Service = row4.Service ;
out4_tmp.Demandeur = row4.Demandeur ;
out4_tmp.Action = row4.Action ;
out4_tmp.Statut = row4.Statut ;
out4_tmp.Complexite = row4.Complexite ;
out4_tmp.Commentaire = row4.Commentaire ;
out4_tmp.Data_Analyst = row4.Data_Analyst ;
out4_tmp.Date_de_debut_de_traitement = row4.Date_de_debut_de_traitement ;
out4_tmp.Delai_traitement = row4.Delai_traitement ;
out4_tmp.Date_de_livraison = row4.Date_de_livraison ;
out4_tmp.TYPE_ACTIVITE = "Maintenance et Docs";
out4 = out4_tmp;
} // closing filter/reject
// ###############################
...
// for output
			...
			row6.Date_arrivee = out4.Date_arrivee;								
			row6.Service = out4.Service;								
			row6.Demandeur = out4.Demandeur;								
			row6.Action = out4.Action;								
			row6.Statut = out4.Statut;								
			row6.Complexite = out4.Complexite;								
			row6.Commentaire = out4.Commentaire;								
			row6.Data_Analyst = out4.Data_Analyst;								
			row6.Date_de_debut_de_traitement = out4.Date_de_debut_de_traitement;								
			row6.Delai_traitement = out4.Delai_traitement;								
			row6.Date_de_livraison = out4.Date_de_livraison;								
			row6.TYPE_ACTIVITE = out4.TYPE_ACTIVITE;			
...
globalMap.put("tUnite_1_NB_LINE", nb_line_tUnite_1);
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"out1","out3","out4","out2");
			  	}
...
int connectionTimeout_tFTPConnection_1 = Integer.valueOf(0);
	...
	class MyTrust_tFTPConnection_1 {
		...
		throws java.security.KeyStoreException, java.security.NoSuchAlgorithmException, 
			...
			java.security.KeyStore ks = java.security.KeyStore.getInstance("JKS");
				...
				String decryptedKeyStorePassword_tFTPConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:EDB35gjzFme0b2lSpQa7nwRXZ7fGTw31McCiO5G8Eb0=");
	...
	final String decryptedPassword_tFTPConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:3a9BYxyZPEvKd/KAuzEoHSVkeEkJiiZHYCeyZYtn3s3qsZaNlrn8O3U7rxyb1xoWcDZHdapbrsviQZZH");
...
int nb_file_tFTPPut_1 = 0;
		...
		String remotedir_tFTPPut_1 = ("./Suivi_Activite").replaceAll("\\\\", "/");
		...
		java.util.List<java.util.Map<String,String>> listtFTPPut_1 = new java.util.ArrayList<java.util.Map<String,String>>();
			...
			maptFTPPut_10.put("Suivi_Act.csv", "");
			listtFTPPut_1.add(maptFTPPut_10);
		String localdirtFTPPut_1 = "C:/Users/DKHUON/Desktop/HAPPI/FTPToucan/Suivi_Activite";
 ...
 */
    ...
    public static void main(String[] args){
        final Suivi_activite Suivi_activiteClass = new Suivi_activite();

        int exitCode = Suivi_activiteClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Suivi_activite.class.getClassLoader().getResourceAsStream("happi/suivi_activite_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Suivi_activite.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Suivi_activite");
        }
...
/************************************************************************************************
 *     257943 characters generated by Talend Open Studio for Data Integration 
 *     on the 21 octobre 2022 08:41:48 CEST
 ************************************************************************************************/