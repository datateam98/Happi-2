...
package happi.mv_dp_vacance_0_3;
...
/**
 * Job: MV_DP_VACANCE Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class MV_DP_VACANCE implements TalendJob {
...
public String getMail1(){
	...
	private final String jobName = "MV_DP_VACANCE";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				MV_DP_VACANCE.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(MV_DP_VACANCE.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public void tDBConnection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:UGUpR5w1bmxPE1oGEczrV5B+G7Xna1Q6Hrpf3Q==");
 ...
 */
	...
	currentComponent="tFileCopy_4";
        ...
        String srcFileName_tFileCopy_4 = "S:/Direction de la Maîtrise de la Performance/3-DATA ANALYST/05 - Template/MV/DP/VACANCE.xlsx";
        ...
        String desDirName_tFileCopy_4 = "C:/MV";

		String desFileName_tFileCopy_4 =  "MV_DP " + context.Nom +"_Vacance_" + TalendDate.getDate("CCYYMMDD") +".xlsx" ;
...
public static class sortie_finalStruct implements routines.system.IPersistableRow<sortie_finalStruct> {
    final static byte[] commonByteArrayLock_HAPPI_MV_DP_VACANCE = new byte[0];
    static byte[] commonByteArray_HAPPI_MV_DP_VACANCE = new byte[0];
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_HAPPI_MV_DP_VACANCE) {
...
public static class row6Struct implements routines.system.IPersistableRow<row6Struct> {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_HAPPI_MV_DP_VACANCE.length) {
				if(length < 1024 && commonByteArray_HAPPI_MV_DP_VACANCE.length == 0) {
   					commonByteArray_HAPPI_MV_DP_VACANCE = new byte[1024];
				} else {
   					commonByteArray_HAPPI_MV_DP_VACANCE = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_HAPPI_MV_DP_VACANCE, 0, length);
			strReturn = new String(commonByteArray_HAPPI_MV_DP_VACANCE, 0, length, utf8Charset);
		}
		return strReturn;
	}
...
+"LB_NATLOC In ('ASSOCIATIONS','ATELIER ARTISTE','LOGEMENT','LOGEMENT CIAL.','PAVILLON') \n	and MOTIF_VAC <> 'Non Renseign"
...
+") as PVT\n";
            ...
            row4.CD_PATRIM1 = rs_tDBInput_4.getInt(1);
            ...
            if(tmpContent_tDBInput_4 != null) {
            	if (talendToDBList_tDBInput_4 .contains(rsmd_tDBInput_4.getColumnTypeName(2).toUpperCase(java.util.Locale.ENGLISH))) {
                	...
                	row4.CD_LOCALI1 = tmpContent_tDBInput_4.trim();
                }
            } else {
                row4.CD_LOCALI1 = null;
            }
            ...
            row4.VACANT = rs_tDBInput_4.getInt(3);
            if(rs_tDBInput_4.wasNull()){
            ...
            row4.REHABILITATION = rs_tDBInput_4.getInt(4);
            if(rs_tDBInput_4.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row4.RELOGEMENT = rs_tDBInput_4.getInt(5);
            if(rs_tDBInput_4.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row4.TECHNIQUE = rs_tDBInput_4.getInt(6);
            if(rs_tDBInput_4.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row4.DIAGNOSTIC_AMIANTE = rs_tDBInput_4.getInt(7);
            if(rs_tDBInput_4.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row4.TRAVAUX_AMIANTE = rs_tDBInput_4.getInt(8);
            if(rs_tDBInput_4.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row4.ADMINISTRATIF = rs_tDBInput_4.getInt(9);
            if(rs_tDBInput_4.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row4.SQUATT = rs_tDBInput_4.getInt(10);
            if(rs_tDBInput_4.wasNull()){
                    row4.SQUATT = null;
            }
		                    }
            ...
            row4.SINISTRE = rs_tDBInput_4.getInt(11);
            if(rs_tDBInput_4.wasNull()){
                    row4.SINISTRE = null;
            }
		                    }
            ...
            row4.IMPRODUCTIF = rs_tDBInput_4.getInt(12);
            if(rs_tDBInput_4.wasNull()){
                    row4.IMPRODUCTIF = null;
            }
		                    }
            ...
            row4.ACCESSION = rs_tDBInput_4.getInt(13);
            if(rs_tDBInput_4.wasNull()){
                    row4.ACCESSION = null;
            }
		                    }
 ...
 */
	...
	currentComponent="tFileOutputExcel_4";
		...
		xlsxTool_tFileOutputExcel_4.setXY(true,0,1,false);
	...
	currentComponent="tFileOutputExcel_4";
				...
				xlsxTool_tFileOutputExcel_4.addRow();
	    				...
	    				if(sortie_final.Maj != null) {
							...
							xlsxTool_tFileOutputExcel_4.addCellValue(sortie_final.Maj, "dd/MM/yyyy");
	    				} else {
	    				...
	    				if(sortie_final.TxVacLgt != null) {
							...
							xlsxTool_tFileOutputExcel_4.addCellValue(Double.parseDouble(String.valueOf(sortie_final.TxVacLgt)));
	    				} else {
	    					xlsxTool_tFileOutputExcel_4.addCellNullValue();
	    				}
	    				...
	    				if(sortie_final.TxVacPark != null) {
							...
							xlsxTool_tFileOutputExcel_4.addCellValue(Double.parseDouble(String.valueOf(sortie_final.TxVacPark)));
	    				} else {
	    					xlsxTool_tFileOutputExcel_4.addCellNullValue();
	    				}
	    				...
	    				if(sortie_final.TxVacLgtM1 != null) {
							...
							xlsxTool_tFileOutputExcel_4.addCellValue(Double.parseDouble(String.valueOf(sortie_final.TxVacLgtM1)));
	    				} else {
	    					xlsxTool_tFileOutputExcel_4.addCellNullValue();
	    				}
	    				...
	    				if(sortie_final.TxVacParkM1 != null) {
							...
							xlsxTool_tFileOutputExcel_4.addCellValue(Double.parseDouble(String.valueOf(sortie_final.TxVacParkM1)));
	    				} else {
	    					xlsxTool_tFileOutputExcel_4.addCellNullValue();
	    				}
	    				...
	    				if(sortie_final.ObjLgt != null) {
							...
							xlsxTool_tFileOutputExcel_4.addCellValue(Double.parseDouble(String.valueOf(sortie_final.ObjLgt)));
	    				} else {
	    					xlsxTool_tFileOutputExcel_4.addCellNullValue();
	    				}
	    				...
	    				if(sortie_final.PerteFi != null) {
							...
							xlsxTool_tFileOutputExcel_4.addCellValue(Double.parseDouble(String.valueOf(sortie_final.PerteFi)));
	    				} else {
	    					xlsxTool_tFileOutputExcel_4.addCellNullValue();
	    				}
	    				...
	    				if(sortie_final.TxRemplissage != null) {
							...
							xlsxTool_tFileOutputExcel_4.addCellValue(Double.parseDouble(String.valueOf(sortie_final.TxRemplissage)));
	    				} else {
	    					xlsxTool_tFileOutputExcel_4.addCellNullValue();
	    				}
					
									
							xlsxTool_tFileOutputExcel_4.addCellValue(Double.parseDouble(String.valueOf(sortie_final.LocatairePotentiel)));
									
							xlsxTool_tFileOutputExcel_4.addCellValue(Double.parseDouble(String.valueOf(sortie_final.VACANT)));
									
							xlsxTool_tFileOutputExcel_4.addCellValue(Double.parseDouble(String.valueOf(sortie_final.REHABILITATION)));
									
							xlsxTool_tFileOutputExcel_4.addCellValue(Double.parseDouble(String.valueOf(sortie_final.RELOGEMENT)));
									
							xlsxTool_tFileOutputExcel_4.addCellValue(Double.parseDouble(String.valueOf(sortie_final.TECHNIQUE)));
									
							xlsxTool_tFileOutputExcel_4.addCellValue(Double.parseDouble(String.valueOf(sortie_final.DIAGNOSTIC_AMIANTE)));
									
							xlsxTool_tFileOutputExcel_4.addCellValue(Double.parseDouble(String.valueOf(sortie_final.TRAVAUX_AMIANTE)));
									
							xlsxTool_tFileOutputExcel_4.addCellValue(Double.parseDouble(String.valueOf(sortie_final.ADMINISTRATIF)));
									
							xlsxTool_tFileOutputExcel_4.addCellValue(Double.parseDouble(String.valueOf(sortie_final.SQUATT)));
									
							xlsxTool_tFileOutputExcel_4.addCellValue(Double.parseDouble(String.valueOf(sortie_final.SINISTRE)));
									
							xlsxTool_tFileOutputExcel_4.addCellValue(Double.parseDouble(String.valueOf(sortie_final.IMPRODUCTIF)));
									
							xlsxTool_tFileOutputExcel_4.addCellValue(Double.parseDouble(String.valueOf(sortie_final.ACCESSION)));
...
+"SSOCIATIONS','ATELIER ARTISTE','LOGEMENT','LOGEMENT CIAL.','PAVILLON') \ngroup by pg.CD_LOCALI1,\npg.CD_PATRIM1\n";
            ...
            if(tmpContent_tDBInput_12 != null) {
            	if (talendToDBList_tDBInput_12 .contains(rsmd_tDBInput_12.getColumnTypeName(1).toUpperCase(java.util.Locale.ENGLISH))) {
            		row31.CD_LOCALI1 = FormatterUtils.formatUnwithE(tmpContent_tDBInput_12);
            	} else {
                	row31.CD_LOCALI1 = tmpContent_tDBInput_12.trim();
                }
            } else {
                row31.CD_LOCALI1 = null;
            }
            ...
            row31.Groupe = rs_tDBInput_12.getInt(2);
            ...
            row31.NB = rs_tDBInput_12.getInt(3);
            if(rs_tDBInput_12.wasNull()){
                    row31.NB = null;
            }
		                    }
 ...
 */
    ...
    Operator_tFilterRow_10 ope_tFilterRow_10 = new Operator_tFilterRow_10("&&");
            ope_tFilterRow_10.matches((row33.NB == null? false : row33.NB.compareTo(ParserUtils.parseTo_Integer(String.valueOf(0))) != 0)
	...
	currentComponent="tFileOutputExcel_5";
				...
				xlsxTool_tFileOutputExcel_5.addRow();
	    				...
	    				if(row36.Groupe != null) {
							...
							xlsxTool_tFileOutputExcel_5.addCellValue(Double.parseDouble(String.valueOf(row36.Groupe)));
	    				} else {
	    				...
	    				if(row36.NB != null) {
							...
							xlsxTool_tFileOutputExcel_5.addCellValue(Double.parseDouble(String.valueOf(row36.NB)));
	    				} else {
	    					xlsxTool_tFileOutputExcel_5.addCellNullValue();
	    				}
...
+"> DATE)\n	AND DTD_PAT_G <= DATE\n";
            ...
            if(tmpContent_tDBInput_14 != null) {
            	if (talendToDBList_tDBInput_14 .contains(rsmd_tDBInput_14.getColumnTypeName(1).toUpperCase(java.util.Locale.ENGLISH))) {
            		row37.CD_LOCALI1 = FormatterUtils.formatUnwithE(tmpContent_tDBInput_14);
            	} else {
                	row37.CD_LOCALI1 = tmpContent_tDBInput_14.trim();
                }
            } else {
                row37.CD_LOCALI1 = null;
            }
            ...
            row37.Groupe = rs_tDBInput_14.getInt(2);
            ...
            row37.NB_PAT = rs_tDBInput_14.getFloat(3);
            if(rs_tDBInput_14.wasNull()){
                    row37.NB_PAT = null;
            }
		                    }
            ...
            row37.NB_VACANT = rs_tDBInput_14.getFloat(4);
            if(rs_tDBInput_14.wasNull()){
                    row37.NB_VACANT = null;
            }
		                    }
...
if(out3 != null) { 
    ...
    Operator_tFilterRow_8 ope_tFilterRow_8 = new Operator_tFilterRow_8("&&");
            ope_tFilterRow_8.matches((out3.DP == null? false : out3.DP.compareTo(context.Nom) == 0)
                           , "DP.compareTo(context.Nom) == 0 failed");
 ...
 */
    ...
    Operator_tFilterRow_11 ope_tFilterRow_11 = new Operator_tFilterRow_11("&&");
            ope_tFilterRow_11.matches((row40.NB_VACANT == null? false : row40.NB_VACANT.compareTo(ParserUtils.parseTo_Float(String.valueOf(0))) != 0)
	...
	currentComponent="tFileOutputExcel_6";
				...
				xlsxTool_tFileOutputExcel_6.addRow();
	    				...
	    				if(row43.Groupe != null) {
							...
							xlsxTool_tFileOutputExcel_6.addCellValue(Double.parseDouble(String.valueOf(row43.Groupe)));
	    				} else {
	    				...
	    				if(row43.TxGroupe != null) {
							...
							xlsxTool_tFileOutputExcel_6.addCellValue(Double.parseDouble(String.valueOf(row43.TxGroupe)));
	    				} else {
	    					xlsxTool_tFileOutputExcel_6.addCellNullValue();
	    				}
...
+":00:00'}\n	OR a.DTF_PAT_G > a.DATE)\n	AND a.DTD_PAT_G <= a.DATE\n	AND a.CD_ETAT = 'MS'\n) T_BASE\n";
            ...
            row44.Groupe = rs_tDBInput_16.getInt(1);
            ...
            if(tmpContent_tDBInput_16 != null) {
            	if (talendToDBList_tDBInput_16 .contains(rsmd_tDBInput_16.getColumnTypeName(2).toUpperCase(java.util.Locale.ENGLISH))) {
            		row44.CD_LOCALI1 = FormatterUtils.formatUnwithE(tmpContent_tDBInput_16);
            	} else {
                	row44.CD_LOCALI1 = tmpContent_tDBInput_16.trim();
                }
            } else {
                row44.CD_LOCALI1 = null;
            }
            ...
            row44.Duree_Mois = rs_tDBInput_16.getInt(3);
            if(rs_tDBInput_16.wasNull()){
                    row44.Duree_Mois = null;
            }
		                    }
...
if(out5 != null) { 
    ...
    Operator_tFilterRow_9 ope_tFilterRow_9 = new Operator_tFilterRow_9("&&");
            ope_tFilterRow_9.matches((out5.DP == null? false : out5.DP.compareTo(context.Nom) == 0)
                           , "DP.compareTo(context.Nom) == 0 failed");
            ope_tFilterRow_9.matches((out5.Duree_Mois == null? false : out5.Duree_Mois.compareTo(ParserUtils.parseTo_Integer(String.valueOf(6))) >= 0)
	...
	currentComponent="tFileOutputExcel_7";
				...
				xlsxTool_tFileOutputExcel_7.addRow();
	    				...
	    				if(row50.Groupe != null) {
							...
							xlsxTool_tFileOutputExcel_7.addCellValue(Double.parseDouble(String.valueOf(row50.Groupe)));
	    				} else {
	    				...
	    				if(row50.Duree_Mois != null) {
							...
							xlsxTool_tFileOutputExcel_7.addCellValue(Double.parseDouble(String.valueOf(row50.Duree_Mois)));
	    				} else {
	    					xlsxTool_tFileOutputExcel_7.addCellNullValue();
	    				}
 ...
 */
	...
	currentComponent="tAdvancedHash_row10";
		...
		int tos_count_tAdvancedHash_row10 = 0;
			   		...
			   		// linked node: tMap_3 - inputs:(row10,row8) outputs:(out2)
 ...
 */
	...
	currentComponent="tAdvancedHash_row19";
		...
		int tos_count_tAdvancedHash_row19 = 0;
			   		...
			   		// linked node: tMap_4 - inputs:(row19,row13) outputs:(copyOfout2)
 ...
 */
	...
	final String decryptedPassword_tDBInput_5 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:JSJlPxePr7FClixHOUeH9V7NYAj6U6db+vCDrw==");
...
+"= 'MS'\n	AND (DTF_PAT_G ={ts '1900-01-01 00:00:00'}\n	OR DTF_PAT_G > DATE)\n	AND DTD_PAT_G <= DATE\n";
			...
			row8.MajDATE = mssqlGTU_tDBInput_6.getDate(rsmd_tDBInput_6, rs_tDBInput_6, 1);
            ...
            if(tmpContent_tDBInput_6 != null) {
            	if (talendToDBList_tDBInput_6 .contains(rsmd_tDBInput_6.getColumnTypeName(2).toUpperCase(java.util.Locale.ENGLISH))) {
            		row8.CD_LOCALI1 = FormatterUtils.formatUnwithE(tmpContent_tDBInput_6);
            	} else {
                	row8.CD_LOCALI1 = tmpContent_tDBInput_6.trim();
                }
            } else {
                row8.CD_LOCALI1 = null;
            }
            ...
            row8.NB_PAT = rs_tDBInput_6.getFloat(3);
            ...
            row8.NB_VACANT = rs_tDBInput_6.getFloat(4);
            if(rs_tDBInput_6.wasNull()){
                    row8.NB_VACANT = null;
            }
		                    }
            ...
            row8.CptVacantPers = rs_tDBInput_6.getInt(5);
            if(rs_tDBInput_6.wasNull()){
                    row8.CptVacantPers = null;
            }
		                    }
            ...
            row8.CD_PATRIM1 = rs_tDBInput_6.getInt(6);
            if(rs_tDBInput_6.wasNull()){
                    row8.CD_PATRIM1 = null;
            }
		                    }
 ...
 */
	...
	currentComponent="tAdvancedHash_row12";
		...
		int tos_count_tAdvancedHash_row12 = 0;
			   		...
			   		// linked node: tMap_2 - inputs:(row7,row12,row22,row23,row24,row29) outputs:(sortie_final)
...
+"	--and param.DP = 'BAGNEUX'\n	and SIO_LB_NATLOC In ('ASSOCIATIONS','ATELIER ARTISTE','LOGEMENT','LOGEMENT CIAL.','PAVILL"
+"ON') \n	and CD_PATRIM4 <>  0\n	and CD_ETAT = 'MS'\n	AND (DTF_PAT_G ={ts '1900-01-01 00:00:00'}\n	OR DTF_PAT_G > DATE)\n	"
+"AND DTD_PAT_G <= DATE\n";
            ...
            row13.NB_PAT = rs_tDBInput_7.getFloat(2);
            ...
            row13.NB_VACANT = rs_tDBInput_7.getFloat(3);
            if(rs_tDBInput_7.wasNull()){
                    row13.NB_VACANT = null;
            }
		                    }
            ...
            row13.CD_PATRIM1 = rs_tDBInput_7.getInt(4);
            if(rs_tDBInput_7.wasNull()){
                    row13.CD_PATRIM1 = null;
            }
		                    }
...
+"D_ETAT = 'MS'\n	AND (DTF_PAT_G ={ts '1900-01-01 00:00:00'}\n	OR DTF_PAT_G > DATE)\n	AND DTD_PAT_G <= DATE\n";
            ...
            if(tmpContent_tDBInput_8 != null) {
            	if (talendToDBList_tDBInput_8 .contains(rsmd_tDBInput_8.getColumnTypeName(1).toUpperCase(java.util.Locale.ENGLISH))) {
            		row15.CD_LOCALI1 = FormatterUtils.formatUnwithE(tmpContent_tDBInput_8);
            	} else {
                	row15.CD_LOCALI1 = tmpContent_tDBInput_8.trim();
                }
            } else {
                row15.CD_LOCALI1 = null;
            }
            ...
            row15.NB_PAT = rs_tDBInput_8.getFloat(2);
            ...
            row15.NB_VACANT = rs_tDBInput_8.getFloat(3);
            if(rs_tDBInput_8.wasNull()){
                    row15.NB_VACANT = null;
            }
		                    }
            ...
            row15.CD_PATRIM1 = rs_tDBInput_8.getInt(4);
            if(rs_tDBInput_8.wasNull()){
                    row15.CD_PATRIM1 = null;
            }
		                    }
...
+"D_ETAT = 'MS'\n	AND (DTF_PAT_G ={ts '1900-01-01 00:00:00'}\n	OR DTF_PAT_G > DATE)\n	AND DTD_PAT_G <= DATE\n";
            ...
            if(tmpContent_tDBInput_9 != null) {
            	if (talendToDBList_tDBInput_9 .contains(rsmd_tDBInput_9.getColumnTypeName(1).toUpperCase(java.util.Locale.ENGLISH))) {
            		row17.CD_LOCALI1 = FormatterUtils.formatUnwithE(tmpContent_tDBInput_9);
            	} else {
                	row17.CD_LOCALI1 = tmpContent_tDBInput_9.trim();
                }
            } else {
                row17.CD_LOCALI1 = null;
            }
            ...
            row17.NB_PAT = rs_tDBInput_9.getFloat(2);
            ...
            row17.NB_VACANT = rs_tDBInput_9.getFloat(3);
            if(rs_tDBInput_9.wasNull()){
                    row17.NB_VACANT = null;
            }
		                    }
            ...
            row17.CD_PATRIM1 = rs_tDBInput_9.getInt(4);
            if(rs_tDBInput_9.wasNull()){
                    row17.CD_PATRIM1 = null;
            }
		                    }
...
+"D UPPER(s.MOTIF_VAC) like '%VACANT%' \ngroup by s.CD_LOCALI1, CD_PATRIM1\n";
            ...
            if(tmpContent_tDBInput_10 != null) {
            	if (talendToDBList_tDBInput_10 .contains(rsmd_tDBInput_10.getColumnTypeName(1).toUpperCase(java.util.Locale.ENGLISH))) {
            		row25.CD_LOCALI1 = FormatterUtils.formatUnwithE(tmpContent_tDBInput_10);
            	} else {
                	row25.CD_LOCALI1 = tmpContent_tDBInput_10.trim();
                }
            } else {
                row25.CD_LOCALI1 = null;
            }
            ...
            row25.CD_PATRIM1 = rs_tDBInput_10.getInt(2);
            ...
            row25.PerteFi = rs_tDBInput_10.getFloat(3);
            if(rs_tDBInput_10.wasNull()){
                    row25.PerteFi = null;
            }
		                    }
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row27";
		...
		int tos_count_tAdvancedHash_row27 = 0;
			   		...
			   		// source node:tDBInput_11 - inputs:(after_tDBInput_10) outputs:(row27,row27) | target node:tAdvancedHash_row27 - inputs:(row27) outputs:()
			   		// linked node: tMap_7 - inputs:(row28,row25,row27) outputs:(copyOfcopyOfout2_1)
...
+"L.','PAVILLON', 'LGT GARDIEN')\ngroup by s.CD_LOCALI1, CD_PATRIM1\n";
            ...
            if(tmpContent_tDBInput_11 != null) {
            	if (talendToDBList_tDBInput_11 .contains(rsmd_tDBInput_11.getColumnTypeName(1).toUpperCase(java.util.Locale.ENGLISH))) {
            		row27.CD_LOCALI1 = FormatterUtils.formatUnwithE(tmpContent_tDBInput_11);
            	} else {
                	row27.CD_LOCALI1 = tmpContent_tDBInput_11.trim();
                }
            } else {
                row27.CD_LOCALI1 = null;
            }
            ...
            row27.CD_PATRIM1 = rs_tDBInput_11.getInt(2);
            ...
            row27.Facturable = rs_tDBInput_11.getFloat(3);
            if(rs_tDBInput_11.wasNull()){
                    row27.Facturable = null;
            }
		                    }
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row32";
		...
		int tos_count_tAdvancedHash_row32 = 0;
			   		...
			   		// source node:tDBInput_13 - inputs:(after_tDBInput_12) outputs:(row32,row32) | target node:tAdvancedHash_row32 - inputs:(row32) outputs:()
 ...
 */
	...
	final String decryptedPassword_tDBInput_13 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:445DFuCrdLhPkUu5e845/NP/g8GOnpCoOsTDiQ==");
...
+"\nDT\nfrom T_DEF_LOCALISATION\n";
            ...
            if(tmpContent_tDBInput_13 != null) {
            	if (talendToDBList_tDBInput_13 .contains(rsmd_tDBInput_13.getColumnTypeName(1).toUpperCase(java.util.Locale.ENGLISH))) {
            		row32.CD_LOCALI1 = FormatterUtils.formatUnwithE(tmpContent_tDBInput_13);
            	} else {
                	row32.CD_LOCALI1 = tmpContent_tDBInput_13;
                }
            } else {
                row32.CD_LOCALI1 = null;
            }
            ...
            if(tmpContent_tDBInput_13 != null) {
            	if (talendToDBList_tDBInput_13 .contains(rsmd_tDBInput_13.getColumnTypeName(2).toUpperCase(java.util.Locale.ENGLISH))) {
            		row32.VILLE = FormatterUtils.formatUnwithE(tmpContent_tDBInput_13);
            	} else {
                	row32.VILLE = tmpContent_tDBInput_13;
                }
            } else {
                row32.VILLE = null;
            }
            ...
            if(tmpContent_tDBInput_13 != null) {
            	if (talendToDBList_tDBInput_13 .contains(rsmd_tDBInput_13.getColumnTypeName(3).toUpperCase(java.util.Locale.ENGLISH))) {
            		row32.DP = FormatterUtils.formatUnwithE(tmpContent_tDBInput_13);
            	} else {
                	row32.DP = tmpContent_tDBInput_13;
                }
            } else {
                row32.DP = null;
            }
            ...
            if(tmpContent_tDBInput_13 != null) {
            	if (talendToDBList_tDBInput_13 .contains(rsmd_tDBInput_13.getColumnTypeName(4).toUpperCase(java.util.Locale.ENGLISH))) {
            		row32.DT = FormatterUtils.formatUnwithE(tmpContent_tDBInput_13);
            	} else {
                	row32.DT = tmpContent_tDBInput_13;
                }
            } else {
                row32.DT = null;
            }
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row38";
		...
		int tos_count_tAdvancedHash_row38 = 0;
			   		...
			   		// source node:tDBInput_15 - inputs:(after_tDBInput_14) outputs:(row38,row38) | target node:tAdvancedHash_row38 - inputs:(row38) outputs:()
 ...
 */
	...
	final String decryptedPassword_tDBInput_15 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:lRtOd5TTmSB5k5UiZV6eNGpXUJjgPDc9q8qy+Q==");
				
				String dbPwd_tDBInput_15 = decryptedPassword_tDBInput_15;
				
		    String port_tDBInput_15 = "1433";
		    String dbname_tDBInput_15 = "HDSHData" ;
			String url_tDBInput_15 = "jdbc:jtds:sqlserver://" + "SRVTOU01" ;
		    if (!"".equals(port_tDBInput_15)) {
		    	url_tDBInput_15 += ":" + "1433";
		    }
		    if (!"".equals(dbname_tDBInput_15)) {
				url_tDBInput_15 += "//" + "HDSHData"; 
		    }
...
+"\nDT\nfrom T_DEF_LOCALISATION\n";
            ...
            if(tmpContent_tDBInput_15 != null) {
            	if (talendToDBList_tDBInput_15 .contains(rsmd_tDBInput_15.getColumnTypeName(1).toUpperCase(java.util.Locale.ENGLISH))) {
            		row38.CD_LOCALI1 = FormatterUtils.formatUnwithE(tmpContent_tDBInput_15);
            	} else {
                	row38.CD_LOCALI1 = tmpContent_tDBInput_15;
                }
            } else {
                row38.CD_LOCALI1 = null;
            }
            ...
            if(tmpContent_tDBInput_15 != null) {
            	if (talendToDBList_tDBInput_15 .contains(rsmd_tDBInput_15.getColumnTypeName(2).toUpperCase(java.util.Locale.ENGLISH))) {
            		row38.VILLE = FormatterUtils.formatUnwithE(tmpContent_tDBInput_15);
            	} else {
                	row38.VILLE = tmpContent_tDBInput_15;
                }
            } else {
                row38.VILLE = null;
            }
           		...
           		tmpContent_tDBInput_15 = rs_tDBInput_15.getString(3);
            if(tmpContent_tDBInput_15 != null) {
            	if (talendToDBList_tDBInput_15 .contains(rsmd_tDBInput_15.getColumnTypeName(3).toUpperCase(java.util.Locale.ENGLISH))) {
            		row38.DP = FormatterUtils.formatUnwithE(tmpContent_tDBInput_15);
            	} else {
                	row38.DP = tmpContent_tDBInput_15;
                }
            } else {
                row38.DP = null;
            }
            ...
            if(tmpContent_tDBInput_15 != null) {
            	if (talendToDBList_tDBInput_15 .contains(rsmd_tDBInput_15.getColumnTypeName(4).toUpperCase(java.util.Locale.ENGLISH))) {
            		row38.DT = FormatterUtils.formatUnwithE(tmpContent_tDBInput_15);
            	} else {
                	row38.DT = tmpContent_tDBInput_15;
                }
            } else {
                row38.DT = null;
            }
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row45";
		...
		int tos_count_tAdvancedHash_row45 = 0;
			   		...
			   		// source node:tDBInput_17 - inputs:(after_tDBInput_16) outputs:(row45,row45) | target node:tAdvancedHash_row45 - inputs:(row45) outputs:()
			   		// linked node: tMap_10 - inputs:(row44,row45) outputs:(out5)
 ...
 */
	...
	final String decryptedPassword_tDBInput_17 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:RHkzkx4Ymd6CYwqTR6MnFAqr2yzeuzdyFGDsNw==");
...
+"\nDT\nfrom T_DEF_LOCALISATION\n";
            ...
            if(tmpContent_tDBInput_17 != null) {
            	if (talendToDBList_tDBInput_17 .contains(rsmd_tDBInput_17.getColumnTypeName(1).toUpperCase(java.util.Locale.ENGLISH))) {
            		row45.CD_LOCALI1 = FormatterUtils.formatUnwithE(tmpContent_tDBInput_17);
            	} else {
                	row45.CD_LOCALI1 = tmpContent_tDBInput_17;
                }
            } else {
                row45.CD_LOCALI1 = null;
            }
            ...
            if(tmpContent_tDBInput_17 != null) {
            	if (talendToDBList_tDBInput_17 .contains(rsmd_tDBInput_17.getColumnTypeName(2).toUpperCase(java.util.Locale.ENGLISH))) {
            		row45.VILLE = FormatterUtils.formatUnwithE(tmpContent_tDBInput_17);
            	} else {
                	row45.VILLE = tmpContent_tDBInput_17;
                }
            } else {
                row45.VILLE = null;
            }
            ...
            if(tmpContent_tDBInput_17 != null) {
            	if (talendToDBList_tDBInput_17 .contains(rsmd_tDBInput_17.getColumnTypeName(3).toUpperCase(java.util.Locale.ENGLISH))) {
            		row45.DP = FormatterUtils.formatUnwithE(tmpContent_tDBInput_17);
            	} else {
                	row45.DP = tmpContent_tDBInput_17;
                }
            } else {
                row45.DP = null;
            }
            ...
            if(tmpContent_tDBInput_17 != null) {
            	if (talendToDBList_tDBInput_17 .contains(rsmd_tDBInput_17.getColumnTypeName(4).toUpperCase(java.util.Locale.ENGLISH))) {
            		row45.DT = FormatterUtils.formatUnwithE(tmpContent_tDBInput_17);
            	} else {
                	row45.DT = tmpContent_tDBInput_17;
                }
            } else {
                row45.DT = null;
            }
 ...
 */
    ...
    public static void main(String[] args){
        final MV_DP_VACANCE MV_DP_VACANCEClass = new MV_DP_VACANCE();

        int exitCode = MV_DP_VACANCEClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = MV_DP_VACANCE.class.getClassLoader().getResourceAsStream("happi/mv_dp_vacance_0_3/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = MV_DP_VACANCE.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
try {
errorCode = null;tFileCopy_4Process(globalMap);
if(!"failure".equals(status)) { status = "end"; }
}catch (TalendException e_tFileCopy_4) {
globalMap.put("tFileCopy_4_SUBPROCESS_STATE", -1);

e_tFileCopy_4.printStackTrace();
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : MV_DP_VACANCE");
        }
...
/************************************************************************************************
 *     915583 characters generated by Talend Open Studio for Data Integration 
 *     on the 3 août 2022 10:40:43 CEST
 ************************************************************************************************/